...
export type GraphQLQuery = {
  ...
  listLives?: Maybe<Array<Maybe<GraphQLLife>>>;
  /** List users */
...
export type GraphQLMutationResolvers<ContextType = Context, ParentType extends GraphQLResolversParentTypes['Mutation'] = GraphQLResolversParentTypes['Mutation']> = {
  ...
  createLife?: Resolver<GraphQLResolversTypes['Life'], ParentType, ContextType, RequireFields<GraphQLMutationCreateLifeArgs, 'birthday' | 'description' | 'firstName' | 'hobbies' | 'lastName'>>;
...
export type GraphQLQueryResolvers<ContextType = Context, ParentType extends GraphQLResolversParentTypes['Query'] = GraphQLResolversParentTypes['Query']> = {
  ...
  listLives?: Resolver<Maybe<Array<Maybe<GraphQLResolversTypes['Life']>>>, ParentType, ContextType>;
