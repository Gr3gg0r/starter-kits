...
export type LifeDataFragment = { __typename?: 'Life', id: string, fullName: string, birthday: string | Date, description: string, firstName: string, lastName: string, hobbies: Array<string> };
...
export type GetLifeQuery = { __typename?: 'Query', getLife?: { __typename?: 'Life', id: string, fullName: string, birthday: string | Date, description: string, firstName: string, lastName: string, hobbies: Array<string> } | null };
...
export function useListLivesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ListLivesQuery, ListLivesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
